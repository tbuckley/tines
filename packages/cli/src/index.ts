...
// named "journal" at exactly project ∧ state. The state is the one this run
// was launched in — not the issue's current state — so a lesson stays with
// the stage that learned it even after the issue has moved on.
