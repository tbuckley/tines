...
import { applyStateRetirement } from '$lib/server/state-retirement/service';
import type { ApplyStateRetirementRequest } from '@tines/shared';
...
export const POST: RequestHandler = api(async (event) => {
	...
	return json(
		await applyStateRetirement(db, env, actor, body as unknown as ApplyStateRetirementRequest)
	);
});
