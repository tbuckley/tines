...
<Popover.Root bind:open>
	...
	<Popover.Portal>
		<Popover.Content
			sideOffset={6}
			align="start"
			class="bg-popover text-popover-foreground data-open:animate-in data-open:fade-in-0 data-open:zoom-in-95 data-closed:animate-out data-closed:fade-out-0 z-50 w-64 rounded-lg p-1 shadow-md ring-1 ring-foreground/10 outline-none"
		>
